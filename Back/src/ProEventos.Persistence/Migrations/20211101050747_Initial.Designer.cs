...
namespace ProEventos.Persistence.Migrations
{
    ...
    [Migration("20211101050747_Initial")]
            ...
            modelBuilder.Entity("ProEventos.Domain.RedeSocial", b =>
                {
                    ...
                    b.ToTable("RedesSociaois");
                });

            modelBuilder.Entity("ProEventos.Domain.Lote", b =>
                {
                    b.HasOne("ProEventos.Domain.Evento", "Envento")
                        .WithMany("Lotes")
                        .HasForeignKey("EventoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProEventos.Domain.Palestrante", "Nome")
                        .WithMany()
                        .HasForeignKey("NomeId");

                    b.Navigation("Envento");
